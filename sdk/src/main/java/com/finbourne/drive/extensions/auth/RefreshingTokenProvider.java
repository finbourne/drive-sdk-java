...
* token expiry to ensure continued connectivity to lusidDrive API without the need
...
public class RefreshingTokenProvider {
    ...
    * that manages direct authentication with lusidDrive.
    *
    * @param httpFinbourneTokenProvider underlying provider that manages explicit authentication calls to lusidDrive
    */
